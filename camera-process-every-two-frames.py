...
def object_detection(cam):
    try:
        ...
        frame_count = 0
        process_every = 2  # Only process every 2nd frame
        ...
        while True:
            ...
            if frame_count % process_every == 0:
                ...
                detected_frame = last_detected_frame if 'last_detected_frame' in locals() else frame
                objects = last_objects if 'last_objects' in locals() else []
